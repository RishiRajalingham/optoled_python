...
class PsychometricFit(object):
    ...
    def get_param_estimates_bounds(self, df):
        ...
        p_lower = np.zeros((4,))
        p_upper = np.zeros((4,))
        p_0[0], p_lower[0], p_upper[0] = p_lin[1], -100, 100
        p_0[1], p_lower[1], p_upper[1] = p_lin[0], -100, 100
        p_0[2], p_lower[2], p_upper[2] = 0, -100, 100
        p_0[3], p_lower[3], p_upper[3] = 0, -100, 100
...
class OptoledAnalyzer(object):
    ...
    def plot_results(self, df):
        ...
        plot_psych_curve(win_index, ax2)
        ax2.set_title('p=%2.2e' % self.all_results[win_index]['p'])
        plt.tight_layout()
